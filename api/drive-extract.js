...
Rules: VIN=17 chars all caps, dates=mm/dd/yyyy, LLC name goes in both applicant_name and business_name, mailing_state defaults MT, odometer priority: when multiple documents give an odometer reading, prefer the POA (power of attorney) value over the title or any other source, only return JSON.`;
