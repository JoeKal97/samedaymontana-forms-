...
Rules: VIN=17 chars all caps, dates=mm/dd/yyyy, LLC name goes in both applicant_name and business_name, mailing_state defaults MT, odometer priority: when multiple documents give an odometer reading, prefer the POA (power of attorney) value over the title or any other source, seller vs buyer: applicant_name is always the buyer/new owner (usually the LLC); seller_name is always the person or party selling the vehicle — never put the LLC or buyer in seller_name, and never put the seller in applicant_name, even if only one name is explicitly labeled, only return JSON.`;
